...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://ecomserver-1-wcij.onrender.com/image/category/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadCategory.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://ecomserver-1-wcij.onrender.com/image/category/${req.file.filename}`;
            }
